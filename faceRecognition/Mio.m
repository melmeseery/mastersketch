...
figure(1);
for i=1:M
    database_directory = './average database/';
    str = strcat(database_directory,num2str(i),'.jpg');
...
for k =1:M
InputImage =imread(strcat('/color dbase1/',num2str(k),'.',num2str(3),'.jpg'));
figure(5)
subplot(1,2,1)
