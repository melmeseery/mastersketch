...
%introduction and motivationss 
 Computers can be easily programed to do things that are difficult to humans, this statement was my assumption for a long time. In my senior year as an undergraduate in computer engineering major I found out that trivial functions for human are the most challenging problems in computer science. This new acquired knowledge put me to think about my previous assumption and gave me new ideas on what are the main problems in computer science. Advanced courses in Artificial Intelligence and computer vision taught me that speaking, listening, seeing and understanding information is the most challenging problems in computer science. Interpreting cursive handwriting,  understanding spoken instructions or even learning a new skill are simple operations for human but are difficult problems in machines. Machine learning and Artificial Intelligence are one of the most active fields in computer science research.
  ...
  My Interest in Artificial intelligence and Image processing encouraged me look for a research problem that combines AI and Image processing as a graduation project. I choose the research to be in (Face recognition and Identification) because the problem is challenging and by helping in solving it will improve in solving a lot of problems. During the project, I was responsible for collecting the data and analyzing the performances of similar systems to finally reach design and help in implementation of a new system. This research showed me what it meant to work in research on one hand the frustration of wrong or unexplained result.On the other hand, the thrill and the continuous motivation to gain more information, ideas and investigate more creative problem solving and thinking techniques. In short, I knew then that I want to continue to work in the scientific research.
	...
	Even thought my dream is to become a scientific researcher I believed that I need more practical experience before more involvement in another academic research. Thus, I  worked for four years as a Software Engineer in a small company called EngNet. Durring my work I gathered some valuable research skills as I was engaged in various discussions and negotiations with clients and my own team members. The experience taught me how to resolve differences between different opinions and compromise to reach a final decisions that will be acceptable by others. I was quickly promoted to Team Leader for a software team of five engineers  where I gained important group comunication skills. As a project leader I had to plan, coordinate, and  supervise my team to achieve the company goals. I continually needed to evaluated my team organizations and operation to guide the team to better engineering practices that will help enhance and maximize the team and company performance. Learning new skills on how to supervise and evaluate operations of software projects lead me to research on how to implement software practices that will improve the company performance and products.
	
 These research activities along with my research oriented graduation project emphasized to me that my dream is to work as researcher in an academic or private institute. Therefore, I was motivated to focus more on my master degree as I was already enrolled as a part time master student in my  university. My Master thesis was on Sketch Recognition and Understanding because it motivated me to. I choose  Working on my Master research supported my tendency to work as a researcher and helped me to improve my analytical skills by working on investigating and evaluation various system through out my research. The research and problem  I faced nurtured my desire to self improvement.
 
	In 2007, I had the opportunity to join 'Signal and Image Processing' research group in Electronic Research Institute (ERI). The position offered a group research enviorment which I believe from my experience is essential for conducting any a constructive research. Engaging in research discussions and meeting opened my mind  on other field of research other that my own this information is by whole helpful in providing me with a breath of information that will sure guide me in my long term goal. My work in ERI focused on investigating and evaluating the use of Swarm Intelligence in field of Image processing. Integrating this work with my thesis in Sketch Recognition.
	
	In my believe that any academic or scientific researcher must acquire at least some tutoring skill and experience. Thus, prior to my work in EngNet company, I worked as Teaching Assistant in October University for Modern Science and Art (MSA). Also, I am currently working as a Teaching assistant in American University in Cairo (AUC), since Sep. 2008. My responsibility include preparing tutorials and course materials, correcting assignment and projects. I am also obliged \textit{(responsible)} to assist in presenting and advising in various courses ranging from Software Engineering and AI to Logic Design and Embeded Systems. Even though my main goal is to become a researcher, teaching is itself an enriching experience and improved my skills in both my professional and personal aspects.% research interset
