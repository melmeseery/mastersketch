...
\begin{center}
	...
	\caption[Segmentation Error]{Different ways for segmenting a stroke drawn by user. a) The stroke users draw b)interpretation as two line segments c) interpretation as an arc.}
