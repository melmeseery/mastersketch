...
Stroke point extraction & Extracting point and computing boundary data & -- &  see Section \ref{} & 
\begin{scriptsize}
...
\end{scriptsize}
 \\ \hline
Possible Dominate point Extraction & Computing and for details see Section\ref{} &  Stroke points  & 1. compute   the pdp  &    Number of $P_{dp}$  = 11
...
The circle is   a = 194.5 ,b = 194.5 , Center( 306.5,  220.0 )   with Error =  2.276869953758031 , Percent =0.9093857875960022
 certainty  =  0.1997008626019765 \\ \hline
