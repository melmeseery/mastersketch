...
E_{tot}=E_{area}+E_{alg}
 \end{equation}
 where $A_{st}$ is the area of the input stroke, $A_{sg}$ is area of computed segmenation, $E_{alg}$ is the Segmentation Error. The segmentation which crosspond to the minimum $E_{tot}$ is the best segmentation.  
  
\section{Hybird Segmentation Algorithm \textsl{Alg3}}
...
\begin{description}
	 ...
	 \item [Strokes] Number of strokes or partical strokes that created the symbols.  
