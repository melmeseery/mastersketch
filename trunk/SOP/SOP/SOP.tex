...
%  I am honored to submit my package to your esteemed Institute. Admitting to a
% PhD program at a leading Computer Science and Engineering Department is a step towards achieving my long-term goal to be a scientific researcher. I am looking forward to a research environment that fosters creativity and encourages the interchange of ideas and cooperation. I have been always interested in the research accomplished at the CSE Department at the University of Minnesota; particularly in the area of Data mining. Several publications of Professors George Karypis and Vipin Kumar are cited in my publica- tions. Prof. Kumar's book, Intoduction to Data Mining, is among the books that introduced me to the field. For all these reasons, I believe that the CSE Department at the University of Minnesota is the most suitable place for me to pursue my PhD.
...
% 	\newpage
% \section*{Part 2: A summary of honors, scholarships, fellowships, and awards}
%   \begin{enumerate}
...
%    Faculty of Engineering, Computer Engineering Department, Cairo University, November, 2009.
...
% \end{enumerate}
%  \section*{Part 4: Relevant work experience}
