...
\subsection{Structural and geometrical Features(FS1)}
 Features defines the structure of the geometrical symbol. Section \ref{sec:steprec} descripe in details how these 13 feature are computed.  
%\begin{description}
...
\item \emph{Size Ratio} Ratio between width to height of the symbol.
		\item \emp{Log of size Ratio} Log of the ratio between width and height of symbol.
	...
	%\item [Ra]		
			\item \emp{Log of Area} Log of area of the symbol.
