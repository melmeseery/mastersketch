...
%\subsection*{Swarm Intelligence History}
...
% Kennedy and Eberhart \cite{PSOFirst,PSO2} introduced Particle Swarm Optimization Algorithm (PSO). The algorithm simulate the moving  Kennedy and Eberhart \cite{PSOFirst,PSO2} introduced particle swarm algorithm (PSO) as a general optimization algorithm. 
 ...
 PSO can be viewed as an algorithm between stochastic search and Evolutionary algorithms\cite{PSOpattern}. Comparison between PSO and Genetic algorithm was perofrmed in \cite{}. Expriments proved that PSO out performe GA in most cases specially in problem with high dimensinalty.  
 \subsection*{PSO neighbourhood topology}  
There is various toplogyies used in connecting a swarm in PSO. The most used is the totaly connected, star and ring topology. 
