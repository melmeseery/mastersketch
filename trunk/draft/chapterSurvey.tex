...
Image processing is one of the displines that used Swarm Intelligance. Ant colony was widely used to segment objects in \cite{antSegmentation,antthreshold,SwarmMedical}. Since 1995 when Kennedy and Eberhart \cite{PSOFirst,PSO2} introduced particle swarm alogrithm (PSO) the algorithm had been used in various image processing sytem as an optimization  algorithm \cite{SwarmImageProcessing,Swarmimageprocessing2,Colorquantization,SwarmMedical}.  PSO algorithm was used in \cite{ToADD} to classify pixel to simplify the object segmentaiton process. 
