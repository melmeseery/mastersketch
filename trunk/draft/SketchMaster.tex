...
\begin{document}
                                                        % TITLE PAGE
                                                        %======================
\title{Sketch recogniton and understanding}             % My theses title
\author{Maha Mohammed Nabeel El Meseery}                               % Y name
\prevdegrees{B.S.,Computer  engineering(2003)}       		% Your old degree
\major{Computer Engineering}                            % My current major
\degree{Master of Science}                              % My new degree
\degreemonth{Dec}                                      % When awarded. to be added when known
\degreeyear{2005}                                      %
%th today or first day of writing  December 26 2005 
\thesisdate[]                                     % Date of document.
\DOCUMENTtype{Survey}                                   % or DISSERTATION
\Documenttype{Survey}                                   % or Dissertation
\documenttype{Survey}                                   % or dissertation
\maketitle
                                                        % COPYRIGHT PAGE
                                                        %======================
\copyrightyear{2005}                                    % Delete these
...
The need for new level of human computer interaction had lead the researchers to attempt improve the current interfaces. Even though the area of research progressed quickly in speech and handwriting systems gesture and sketch understanding systems are still starting to get noticed. This survey will highlight the current research that is ongoing on the sketch recognition and sketch understanding systems.
...
\bibliography{../../neededfiles/Bibliographies/Mybibliography.bib}     
                                                % THE APPENDIX
                                                %==============================
