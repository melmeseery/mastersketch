...
\begin{figure}	
	...
	\caption[Handwriting Ambiguities] {The same handwriting can be interpreted differently in various contexts; In the first line the b can be viewed as a B and in the second one could see it as 8.}
\label{fig:VorU}
\end{figure} 	
